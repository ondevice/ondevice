...
//
// returned by config.GetValue(), and filled by the Key's  validator's constraints (e.g. if the type allows multiple values, they are split up, else everything is put in [0])
//
